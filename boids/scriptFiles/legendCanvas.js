	...
	function(Star, sketch, p5) {
		...
		new p5(function(p) {
			...
			p.draw = function() {
				...
				p.fill(textCol);
				p.text("Healthy ant", textOffset, symbolVOffset + 90);
				...
				p.fill(textCol);
				p.text("Dying ant", textOffset, symbolVOffset + 140);
				...
				// Info messages
				p.fill(textCol);
				p.text("Each ant's health value automatically ", symbolHOffset, symbolVOffset + 300);
				p.text("decreases by " + frameMinus + " per frame.", symbolHOffset, symbolVOffset + 320);
				p.text("Feed the Ants!", symbolHOffset, symbolVOffset + 350);
				...
				p.text("Ant count: " + sketch.numAnts, symbolHOffset, symbolVOffset + 420);
